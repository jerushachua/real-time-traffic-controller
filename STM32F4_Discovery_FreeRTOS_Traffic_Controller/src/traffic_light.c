...
void TrafficLightTask ( void *pvParameters )
{
	...
	while(1)
	{
		...
		{
			printf("Successfully received from Flow Queue: :  %u.\n", new_speed_value );
			printf("Flow Queue -- pop --> %u \n", new_speed_value); 
		}
		else
		{
		 ...
		 * Ex. 5000 * (new_speed_value / 7) + 5000 )for flowrates of [0, 1, 2 ...] = [5000, 5715, 6428, 7142, 7857, 8571, 9285, 10000]
		 * 
		 ...
		 * Ex. 5000 * ( abs(8-new_speed_value) / 7) + 5000 for flow rates of [0, 1, 2 ...] = [10000, 9285, 8571, 7857, 7142, 6428, 5715, 5000]
		 * 
